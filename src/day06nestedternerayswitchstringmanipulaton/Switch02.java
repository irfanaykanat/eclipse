...
/*
  ...
  Your code will print all month names starts with the months number is given by user 
 ...
 */
	...
	/* 1) for whole numbers, you cannot use "long" in switch.
	     for whole number you can use byte, short and int
	...
	*/
	...
	public static void main(String[] args) {
		...
		switch(monthNumber) {
			...
			default:
				System.out.println("Again you did sama mistake, use the numbers from 1 to 12 ");
